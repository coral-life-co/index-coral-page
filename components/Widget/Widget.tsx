...
const WidgetError: React.FC<WidgetErrorProps> = ({ symbol }) => {
    return (
...
const WidgetGraph: React.FC<WidgetGraphProps> = ({ data }) => {
...
export const Widget: React.FC<WidgetProps> = ({ symbol, name }) => {
	...
	const statusMap = {
		error: <WidgetError symbol={symbol} />,
		loading: <WidgetPlaceholder />,
		ok: <>
			<WidgetGraph data={prices} />
			<div className="widget__content">
    ...
    return (
        <StrictMode>
            ...
            <div className="widget-grid">
                <Widget symbol="IBM" name="IBM" />
                {/* <Widget symbol="MSFT" name="Microsoft Corporation" /> */}
            </div>
        </StrictMode>
    );
};